...
class Buy_Mutual_Fund extends StatefulWidget {
  int index;

  Buy_Mutual_Fund(this.index);

  @override
  State<Buy_Mutual_Fund> createState() => _Buy_Mutual_FundState();
}

class _Buy_Mutual_FundState extends State<Buy_Mutual_Fund> {
  @override
                ...
                Row(
                  ...
                  children: [
                    ...
                    (Screen_1.stock == false)
                        ? Text(
                      "Buy ${Stock.Stock_name[widget.index]}",
                      style: Theme
                          .of(context)
                          .textTheme
                          .titleMedium!
                        ...
                        : Text(
                      "Buy ${Stock.mutual_funds[widget.index]}",
                      style: Theme
                          .of(context)
                          .textTheme
                          .titleMedium!
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            color: Colors.white30),
                        child: TextField(
                          controller: (order_type==false)?price_controller:price_controller1,
                          textAlign: TextAlign.center,
                          keyboardType: TextInputType.number,
